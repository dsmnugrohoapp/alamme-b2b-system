...
export default async function FulfillmentPage() {
  ...
  return (
    <div>
      ...
      <div className="card">
        <table>
          <thead><tr><th>No. Order</th><th>Customer</th><th>Status Fulfillment</th><th>Kurir / Resi</th><th></th></tr></thead>
          <tbody>
            {(!orders || orders.length === 0) && <tr><td colSpan={5} className="text-center text-gray-400 py-10">Belum ada order untuk difulfill.</td></tr>}
            {(orders || []).map((o: any) => {
